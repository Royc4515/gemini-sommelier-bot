...
- **Photo → wine info**: Send a wine-label photo on its own (no command) and the bot identifies it and gives a sommelier rundown (style, expected profile, pairing, drink-now-or-hold). Add a caption to ask a specific question. Information only, no cellar write.
